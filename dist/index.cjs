...
var Treedux = class Treedux {
	...
	constructor(dataStores, options) {
		...
		for (const key in this.dataStores) {
			...
			reducerMap[key] = (0, _reduxjs_toolkit.createReducer)(dataStore.getInitialState(), (builder) => {
				Object.entries(dataStore.getReducers()).forEach(([actionType, reducer]) => builder.addCase(actionType, reducer));
			});
		}
		const appReducer = (0, _reduxjs_toolkit.combineReducers)(reducerMap);
		...
		this.storeInstance = (0, _reduxjs_toolkit.configureStore)({
			reducer: rootReducer,
...
var ReadOnlyStateNode = class ReadOnlyStateNode {
	...
	subscribe(callback) {
		...
		return this.treedux.subscribe(() => {
			...
			if ((0, fast_deep_equal.default)(newValue, currentValue)) return;
...
//#endregion
exports.AbstractMutator = AbstractMutator;
exports.Action = Action;
exports.DataStore = DataStore;
exports.DefaultActionEnum = DefaultActionEnum;
